...
namespace FinalCIS3285
{
    public partial class Form10 : Form
    {
        ...
        {
            Form9 f9 = new Form9();
            f9.ShowDialog(); //should show new form??
        }
        ...
        {
            if (textBox1.Text.Equals("10 lords of leaping"))
            {
                answerRecord.Items.Add("question 10: correct");
            }
            else
            {
                answerRecord.Items.Add("question 10: incorrect");
            }
